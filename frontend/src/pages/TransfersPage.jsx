...
const branchSelectStyles = {
  control: (base, state) => ({
    ...
    borderColor: state.isFocused ? '#FF202E' : '#e2e8f0',
    boxShadow: state.isFocused ? '0 0 0 2px rgba(230, 30, 42, 0.2)' : 'none',
    fontSize: '0.875rem',
  ...
  option: (base, state) => ({
    ...base,
    fontSize: '0.875rem',
    backgroundColor: state.isSelected ? '#E61E2A' : state.isFocused ? '#f1f5f9' : 'white',
